...
let addomploi = document.querySelector('.addomploi');
addomploi.addEventListener('click', ()=>{
    window.location.href = 'addomploi.php';
...
let addtaskbtn = document.querySelector('.badg');
